...
public class OI {
    ...
    public OI() {
        ...
        selectButton.whenPressed(new ToteClawClose());
        startButton = new JoystickButton(xboxController, 8);
        startButton.whenPressed(new ToteClawOpen());
        yButton = new JoystickButton(xboxController, 4);
        yButton.whenPressed(new ElevatorFloorPickup());
        xButton = new JoystickButton(xboxController, 3);
        xButton.whenPressed(new ContainerClawClose());
        bButton = new JoystickButton(xboxController, 2);
        bButton.whenPressed(new ContainerClawOpen());
        aButton = new JoystickButton(xboxController, 1);
        aButton.whenPressed(new Stack());
